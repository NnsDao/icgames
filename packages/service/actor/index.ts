...
// nid
export const getNIDActor = async (needAuth?: boolean) =>
  getActor<NIDActor>({ needAuth, ...canister.nid });

// ndp
export const getNDPActor = async (needAuth?: boolean) =>
  getActor<NDPActor>({ needAuth, ...canister.ndp });
